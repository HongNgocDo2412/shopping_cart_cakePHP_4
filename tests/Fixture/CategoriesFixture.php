...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sort' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'sort' => 1,
                'active' => 1,
                'created' => '2021-09-10 07:08:40',
                'modified' => '2021-09-10 07:08:40',
            ],
        ];
        parent::init();
    }
