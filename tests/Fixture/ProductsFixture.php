...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'category_id' => ['type' => 'integer', 'length' => null, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        'slug' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        'description' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        'image' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'name_slug' => ['type' => 'index', 'columns' => ['slug'], 'length' => []],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'views' => 1,
                'active' => 1,
                'created' => '2021-09-10 07:08:02',
                'modified' => '2021-09-10 07:08:02',
            ],
        ];
        parent::init();
    }
